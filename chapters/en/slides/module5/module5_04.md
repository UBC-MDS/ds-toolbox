...
You can write a title for the pull request and description. Remember that you ca use Markdown to give format to that message. You can use the tab **Preview** to have a look before creating the pull request.
