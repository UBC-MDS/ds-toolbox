...
Students will require a laptop meeting the following specifications (details on how to set up your laptop will follow in assignment 1):
 ...
 - Runs one of the following operating systems: Ubuntu 22.04 (20.04 will also likely work), macOS Big Sur (version 11.4.x or 11.5.x), Windows 10 or 11 Home, Professional, Enterprise or Education (version 2004, 20H2, 21H1, or above).
...
- The students will be responsible to complete the material of 2-3 modules every 2 weeks (3 modules for weeks 1-2, 2 modules for weeks 2-4, 3 modules for weeks 4-6).
- In weeks 4 and 7, students will need to take an online 45-minute open-book quiz testing, material from Modules 1-4 and 5-8 respectively. The quizzes can be taken at any point during the week.
...
The Data Science Toolbox is part of the Key Capabilities in Data Science program. You must obtain 70% or higher in Data Visualization and complete the final assignment to obtain a course completion grade. To successfully complete the Key Capabilities in Data Science program, you must complete all four required courses and achieve 70% or higher for each of the four courses. 
...
|---------------|---------------|
| 8 Assignments | 64 (8% each)  |
| 2 Quizzes     | 36 (18% each) |
...
| Week 5-6  | Module 6,<br> Module 7, <br Module 8  | assignment_06, assignment_07                |
| Week 7    | None                                  | quiz_02                                     |
