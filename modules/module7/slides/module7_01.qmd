...
![](../../../static/module7/notebook.png){width="80%" fig-alt="404 image"}
...
![](../../../static/module7/new-notebook.png){width="90%" fig-alt="404 image"}
...
![](../../../static/module7/new-notebook2.png){width="90%" fig-alt="404 image"}
...
![](../../../static/module7/cells.png){width="75%" fig-alt="404 image"}
...
![](../../../static/module7/command-edit.png){width="75%" fig-alt="404 image"}
...
![](../../../static/module7/command-edit2.png){width="60%" fig-alt="404 image"}
...
![](../../../static/module7/run-cell.png){width="70%" fig-alt="404 image"}
...
![](../../../static/module7/console.png){width="70%" fig-alt="404 image"}
...
![](../../../static/module7/console2.png){width="80%" fig-alt="404 image"}
...
For example, the well-known `numpy` package allows you to try out NumPy directly on their web page without installing anything using a special Jupyter Console (under the "Try NumPy" section at [https://numpy.org/](https://numpy.org/))
:::
...
![](../../../static/module7/tab.png){width="50%" fig-alt="404 image"}
...
![](../../../static/module7/help.png){width="90%" fig-alt="404 image"}
...
![](../../../static/module7/help2.png){width="90%" fig-alt="404 image"}
...
![](../../../static/module7/reprod.png){width="90%" fig-alt="404 image"}
...
![](../../../static/module7/comm-pal.png){width="70%" fig-alt="404 image"}
