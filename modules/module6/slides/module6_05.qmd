...
title-slide-attributes:
  data-notes: |
    In this slide deck, we will learn how we can work with multiple version of the same package in different virtual environments.
---
...
![](../../../static/module6/conda-logo.png){width="400px" fig-alt="404 image"}
...
<img style="border:1px solid black;" src="../../../static/module6/conda-activate.png" width="50%">
...
<img style="border:1px solid black;" src="../../../static/module6/conda-env-list.png" width="60%">
...
<img style="border:1px solid black;" src="../../../static/module6/env-yaml-full.png" width="70%">
...
<img style="border:1px solid black;" src="../../../static/module6/env-yaml.png" width="25%">
...
<img style="border:1px solid black;" src="../../../static/module7/jl-launch_dstoolbox.png" width="90%">
...
<img style="border:1px solid black" src="../../../static/module6/conda-help.png" width="80%"/>
...
<img style="border:1px solid black" src="../../../static/module6/conda-version.png" width="40%"/>


:::{.notes}
- To see which Conda commands are available, you can run `conda --help`

<img style="border:1px solid black" src="../../../static/module6/conda-help.png" width="100%"/>
...
<img style="border:1px solid black" src="../../../static/module6/conda-version.png" width="60%"/>
