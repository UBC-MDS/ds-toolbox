...
title-slide-attributes:
  data-notes: |
    In this module we will be learning how to use the shell to communicate with out computer via text-based commands rather than graphical menus that we click with the mouse pointer. To get a deeper understanding of this concept, we will start with a brief introduction to computing in general.
---
...
![](../../../static/module2/wires-computers-eniac-1946.png){width="60%" fig-alt="A few of the world's most prominent programmers of the time computing ballistic trajectories on the ENIAC computer during the second world war."}
...
![](../../../static/module2/file-open-menu.png){width="40%" fig-alt="Selecting open from the file menu"}
...
![](https://cdn.rawgit.com/odb/official-bash-logo/master/assets/Logos/Identity/PNG/BASH_logo-transparent-bg-color.png){fig-alt="The Bourne Again SHell" width="50%"}
...
![](../../../static/module2/launch-jlab.png){width="80%" fig-alt="`jupyter lab` is typed executed from the command line and some of its output is shown."}

<br>

The JupyterLab landing page:

![](../../../static/module2/jlab-launcher.png){width="50%" fig-alt="A screenshot of how the Jupyter Lab launcher looks when it is opened, including the icons for creating new notebooks."}
...
![](../../../static/module2/jl-terminal-open.png){width="60%" fig-alt="A screenshot of opening the terminal in JupyterLab via the File menu."}

<br>

An open JupyterLab terminal with black background:

![](../../../static/module2/jl-terminal.png){width="60%" fig-alt="A screenshot of an open JupyterLab terminal with black background."}
...
:::{.notes}
This module is largely based on the Shell chapters in the book ["Research Software Engineering with Python"](https://merely-useful.tech/py-rse/bash-basics.html), which is freely available and can be referred to for additional details.
:::