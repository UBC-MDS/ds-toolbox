...
![](../../../static/module5/branches-history-jl-t.png){width="90%" fig-alt="404 image" fig-align="center"}
...
that [is available online](https://glosario.carpentries.org/) and also as a library in both R and Python.  
...
![](../../../static/module5/branches-vscode.png){width="80%" fig-alt="404 image" fig-align="center"}
...
![](../../../static/module5/observing-trees.png){width="80%" fig-alt="404 image" fig-align="center"}
...
1. The default `master` branch which is indicated on the topmost row. This is the orange line in the graphical representation to the left and there are five commits visible in this image on this branch (the black dots on the orange line).
