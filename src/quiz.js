function generateQuiz(containerId, title, question, options, correctAnswers) {
    ...
    questionTitle.style.color = '#18763b';
    ...
    Object.entries(options).forEach(([option, explanation], index) => {
        ...
        input.addEventListener('change', function () {
            ...
            if (isCorrect) {
                ...
                messageBody.innerHTML = `<strong style="color: #18763b !important; font-size: 16px">Correct! &nbsp;${emoji}</strong><br>${explanation}`;
                messageElement.style.backgroundColor = '#eafbf0'; // Light background for content
                messageElement.style.borderLeft = '5px solid #18763b'; // Left border styling
            } else {
                messageBody.innerHTML = `<strong style="color: #122baf !important; font-size: 16px;">Incorrect</strong><br>${explanation}`;
                messageElement.style.backgroundColor = '#d1d8fa'; // Light background for content
                messageElement.style.borderLeft = '5px solid #122baf'; // Left border styling
            }
